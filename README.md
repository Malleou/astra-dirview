...
|Задание|Статус|
|---|---|
|Установить Astra Linux 1.7/1.8 на виртуалку|Done|
|Обновиться до последней версии|Done|
|Установить из нашего репозитория QtCreator|Done|
|Взять за основу проект dirview|Done|
|Сделать стартовой директорией домашнюю директорию текущего пользователя|Done|
|Отображать файлы, папки, в том числе и скрытые|Done|
|Добавить QLineEdit виджет, который использовать для фильтрации по имёнам файлов и папок|Done|
|+ Добавить столбец "Размер папки"|Done|
